...
final class UtilsTests: XCTestCase {
  ...
  func testFontFromTraitsAndSize() {
    ...
    expect(updatedFont?.fontDescriptor.symbolicTraits.rawValue)
      .to(
        equal(font.fontDescriptor.symbolicTraits.rawValue + UniversalFontDescriptor.SymbolicTraits.traitBold.rawValue)
      )
  }
